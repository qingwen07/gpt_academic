...
def main():
    ...
    title_html = f"<h1 align=\"center\">GPT 学术优化</h1>{theme_declaration}<h5 align=\"center\">[账号注册：<a href='http://mall.gpt-hub.top' target='_blank'>http://mall.gpt-hub.top</a>][客服QQ:839226604]</h5>"
